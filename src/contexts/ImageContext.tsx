...
export type ImageName = 'dr-rogerio-goulart' | 'rogerio-goulart' | 'rogerio-groulart-02'
...
const CURRENT_IMAGE_SELECTION_VERSION = '2026-03-dr-rogerio-primary'
...
export function ImageProvider({ children }: { children: ReactNode }) {
  const [imageName, setImageName] = useState<ImageName>(() => {
    // Carrega do localStorage ou usa 'dr-rogerio-goulart' como padrão
